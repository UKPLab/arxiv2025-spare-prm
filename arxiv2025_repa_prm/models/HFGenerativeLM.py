...
class HFGenerativeLM:
    ...
    def prepare_batch(
        self, batch, chat_template_config={}, batch_text_postprocessor=None
    ):
        is_chat = False
        if batch:
        ...
        if batch_text_postprocessor:
            batch = [batch_text_postprocessor(i) for i in batch]
    ...
    def generate(
        ...
        batch, is_chat = self.prepare_batch(
            ...
            batch_text_postprocessor=batch_text_postprocessor,
        )
